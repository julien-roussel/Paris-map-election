...
const Home = () => {
  ...
  return (
    <>
      <title>Sufframap - carte d'analyse des élections</title>
      <meta name="description" content="Sufframap est un outil d’exploration et de visualisation des résultats électoraux français, basé sur le niveau le plus granulaire disponible : les bureaux de vote." />
      ...
      <div id="homepage" className='container-scroll'>
          <section id="" className="container-display">
            <div id="container-home-video" className="container-home">
              <video
                className="image-fade visible animated fadeInUp"
                playsInline
                autoPlay
                loop
                muted
                preload="auto"
              >
                <source src="/video/map-video_01.mp4" type="video/mp4" />
              </video>
            </div>
